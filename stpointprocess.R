...
## ----stpointpattern, echo = T, eval = TRUE, result.width='100%', fig.width=9.5, fig.height=3, fig.cap ="Left: Locations of 10443 reports of non-specific gastrointestinal disease in Hampshire from January 2001 to July 2003. The time is treated as a quantitative mark where darker dots correspond to the older events, and lighter dots match the most recent reports. Right: Hampshire population density averaged over the years 2001-2003. The colour map is evenly-spaced on a logarithmic scale.", out.width='\\textwidth'----
...
## ----snapshotsintensity, echo = T, eval = TRUE,  fig.width=9.5, fig.height=3, fig.cap ="Temporal snapshots of the intensity $\\hat{\\lambda}(\\mathbf{u},v)$, of non-specific gastrointestinal reports in Hampshire, estimated in a non-separable way through Gaussian kernels. The units are rescaled by $100$.", out.width='100%'----
...
## ----strisk, echo = T, eval = TRUE,  fig.width=9.5, fig.height=6, fig.cap ="Temporal snapshots of the unconditional risk $\\hat{r}(\\mathbf{u},v)$ (top) and conditional risk $\\hat{r}(\\mathbf{u}|v= t)$ (where $t$ is $01/01/2001$, $01/01/2002$, $01/01/2003$ and $12/31/2003$) (bottom) of non-specific gastrointestinal disease in Hampshire. Solid lines delineate a statistical significant elevated risk at the $5\\%$ level.", out.width='100%'----
...
## ----gfunction, echo = T, eval = TRUE,  fig.width=6, fig.height=6, fig.cap ="Spatio-temporal pair correlation function estimate of non-specific gastrointestinal disease data.", out.width='65%'----
library(plot3D)
par(mar = c(0,0,0,0))
...
## ----Kfunctions, echo = T, eval = TRUE,  fig.width=6, fig.height=6, fig.cap ="Spatio-temporal pair correlation function estimate of non-specific gastrointestinal disease data.", out.width='65%'----
